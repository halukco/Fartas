...
%>
	...
	%>
		...
		Meslek:<input type="text" name="meslek" size="28" value="<% =urunListesi("meslek")  %>"> 
		2. Bilgi:<input type="text" name="yonetimKurulu" size="28" value="<% =urunListesi("yonetimKurulu")  %>"> 
		...
		<% if ayarOku("RUS") = "1" then %> RU:<input type="text" name="menu_adiRus" size="20" value="<% =urunListesi("menu_adiRus")  %>"><%end if%>
...
<table border="0" width="95%" cellpadding="2" align="center">
	...
	<tr>
		<td bgcolor="#efefef" width="50%"><font size="4"><b>Enerji</b></font></td>
		<td bgcolor="#efefef" width="50%">
		<b>
		<a href="#" onclick="window.open('menuEkle.asp?mode=3','_blank','width=350 height=150');">
		<font color="#008000">Ana Kategori Ekle</font></a></b></td>
	</tr>
<%
set solMenuList = kayitSeti("SELECT * from menuler WHERE mode LIKE '3' ORDER BY sira ASC;")
while NOT solMenuList.eof
%>
	<form action="ana_menuler.asp?islem=menuDuzenleSub&id=<% =solMenuList("id") %>" method="POST">
		<tr bgcolor="#CECFD3">
		...
		<div>
		<b>
		<a href="#" onclick="window.open('menuEkle.asp?menuId=<% =solMenuList("id") %>&mode3=1','_blank','width=350 height=150');">
		<font color="navy">Alt Kategori Ekle</font></a></b>
	...
	%>
		...
		<td style="border-bottom: 1px solid #C0C0C0" width="83%">&nbsp;<a href="ana_menuler.asp?islem=menuSil&id=<% =urunListesi("id") %>" onclick="return confirm('Bu icerigi SILMEK istediginize eminmisiniz ?');"><img src="images/del.gif" border="0"></a>
		<a href="altMenuIcerikGir.asp?id=<% =urunListesi("id") %>" title="Yazý"><img src="images/css.gif" border="0"></a>
		<a href="altMenuIcerikGir2.asp?id=<% =urunListesi("id") %>" title="Yazý"><img src="images/css.gif" border="0"></a>
		<a href="altmenuresimler.asp?id=<% =urunListesi("id") %>" title="Fotoðraf"><img src="images/mn_image.gif" border="0"></a>&nbsp; 
		TR:<input type="text" name="menu_adi" size="28" value="<% =urunListesi("menu_adi")  %>"> 
...
<table border="0" width="95%" cellpadding="2" align="center">
	...
	<tr>
		<td bgcolor="#efefef" width="50%"><font size="4"><b>Ýnþaat</b></font></td>
		<td bgcolor="#efefef" width="50%">
		<b>
		<a href="#" onclick="window.open('menuEkle.asp?mode=4','_blank','width=350 height=150');">
		<font color="#008000">Ana Kategori Ekle</font></a></b></td>
	</tr>
<%
set solMenuList = kayitSeti("SELECT * from menuler WHERE mode LIKE '4' ORDER BY sira ASC;")
while NOT solMenuList.eof
%>
	<form action="ana_menuler.asp?islem=menuDuzenleSub&id=<% =solMenuList("id") %>" method="POST">
		<tr bgcolor="#CECFD3">
		...
		<div>
		<b>
		<a href="#" onclick="window.open('menuEkle.asp?menuId=<% =solMenuList("id") %>&mode4=1','_blank','width=350 height=150');">
		<font color="navy">Alt Kategori Ekle</font></a></b>
...
<table border="0" width="95%" cellpadding="2" align="center">
	...
	<tr>
		<td bgcolor="#efefef" width="50%"><font size="4"><b>Bizden Haberler</b></font></td>
		<td bgcolor="#efefef" width="50%">
		<b>
		<a href="#" onclick="window.open('menuEkle.asp?mode=5','_blank','width=350 height=150');">
		<font color="#008000">Ana Kategori Ekle</font></a></b></td>
	</tr>
<%
set solMenuList = kayitSeti("SELECT * from menuler WHERE mode LIKE '5' ORDER BY sira ASC;")
while NOT solMenuList.eof
%>
	<form action="ana_menuler.asp?islem=menuDuzenleSub&id=<% =solMenuList("id") %>" method="POST">
		<tr bgcolor="#CECFD3">
		...
		<a href="altmenuresimler.asp?id=<% =solMenuList("id") %>"><img src="images/mn_image.gif" border="0"></a> 
		TR:<input type="text" name="menu_adi" size="23" value="<% =solMenuList("menu_adi")  %>" style="font-weight:Bold;"> 
		Haberde Video Var:<input type="checkbox" name="bizdenHaberlervideo" value="1" <% if solMenuList("bizdenHaberlervideo") = "1" then %>checked<% end if %>>
		Video Link <b>watch?v' den sonraki link</b>:<input type="text" name="videoLink" size="10" value="<% =solMenuList("videoLink")  %>" style="font-weight:Bold;"> 
		<% if ayarOku("EN") = "1" then %>EN:<input type="text" name="menu_adiEng" size="16" value="<% =solMenuList("menu_adiEng")  %>" style="font-weight:Bold;"><%end if%>
		<% if ayarOku("DE") = "1" then %> DE:<input type="text" name="menu_adiGer" size="16" value="<% =solMenuList("menu_adiGer")  %>" style="font-weight:Bold;"><%end if%>
		<% if ayarOku("AR") = "1" then %> AR:<input type="text" name="menu_adiArb" size="16" value="<% =solMenuList("menu_adiArb")  %>" style="font-weight:Bold;"><%end if%>
		<% if ayarOku("RUS") = "1" then %> RU:<input type="text" name="menu_adiRus" size="16" value="<% =solMenuList("menu_adiRus")  %>" style="font-weight:Bold;"><%end if%>
		...
		<div>
		<b>
		<a href="#" onclick="window.open('menuEkle.asp?menuId=<% =solMenuList("id") %>&mode5=1','_blank','width=350 height=150');">
		<font color="navy">Alt Kategori Ekle</font></a></b>
...
<table border="0" width="95%" cellpadding="2" align="center">
	...
	<tr>
		<td bgcolor="#efefef" width="50%"><font size="4"><b>Hayvancýlýk</b></font></td>
		<td bgcolor="#efefef" width="50%">
		<b>
		<a href="#" onclick="window.open('menuEkle.asp?mode=7','_blank','width=350 height=150');">
		<font color="#008000">Ana Kategori Ekle</font></a></b></td>
	</tr>
<%
set solMenuList = kayitSeti("SELECT * from menuler WHERE mode LIKE '7' ORDER BY sira ASC;")
while NOT solMenuList.eof
%>
	<form action="ana_menuler.asp?islem=menuDuzenleSub&id=<% =solMenuList("id") %>" method="POST">
		<tr bgcolor="#CECFD3">
		...
		<div>
		<b>
		<a href="#" onclick="window.open('menuEkle.asp?menuId=<% =solMenuList("id") %>&mode7=1','_blank','width=350 height=150');">
		<font color="navy">Alt Kategori Ekle</font></a></b>
...
<table border="0" width="95%" cellpadding="2" align="center">
	...
	<tr>
		<td bgcolor="#efefef" width="50%"><font size="4"><b>Grup Þirketleri</b></font></td>
		<td bgcolor="#efefef" width="50%">
		<b>
		<a href="#" onclick="window.open('menuEkle.asp?mode=8','_blank','width=350 height=150');">
		<font color="#008000">Ana Kategori Ekle</font></a></b></td>
	</tr>
<%
set solMenuList = kayitSeti("SELECT * from menuler WHERE mode LIKE '8' ORDER BY sira ASC;")
while NOT solMenuList.eof
%>
	<form action="ana_menuler.asp?islem=menuDuzenleSub&id=<% =solMenuList("id") %>" method="POST">
		<tr bgcolor="#CECFD3">
		...
		<div>
		<b>
		<a href="#" onclick="window.open('menuEkle.asp?menuId=<% =solMenuList("id") %>&mode8=1','_blank','width=350 height=150');">
		<font color="navy">Alt Kategori Ekle</font></a></b>
...
<table border="0" width="95%" cellpadding="2" align="center">
	...
	<tr>
		<td bgcolor="#efefef" width="50%"><font size="4"><b>Mühendislik</b></font></td>
		<td bgcolor="#efefef" width="50%">
		<b>
		<a href="#" onclick="window.open('menuEkle.asp?mode=6','_blank','width=350 height=150');">
		<font color="#008000">Ana Kategori Ekle</font></a></b></td>
	</tr>
<%
set solMenuList = kayitSeti("SELECT * from menuler WHERE mode LIKE '6' ORDER BY sira ASC;")
while NOT solMenuList.eof
%>
	<form action="ana_menuler.asp?islem=menuDuzenleSub&id=<% =solMenuList("id") %>" method="POST">
		<tr bgcolor="#CECFD3">
		...
		<div>
		<b>
		<a href="#" onclick="window.open('menuEkle.asp?menuId=<% =solMenuList("id") %>&mode6=1','_blank','width=350 height=150');">
		<font color="navy">Alt Kategori Ekle</font></a></b>
...
menuDuzenle("meslek") = request.form("meslek")
menuDuzenle("yonetimKurulu") = request.form("yonetimKurulu")
menuDuzenle("videoLink") = request.form("videoLink")
if request.form("bizdenHaberlervideo") = "1" then 
menuDuzenle("bizdenHaberlervideo") = "1"
Else
menuDuzenle("bizdenHaberlervideo") = "0"
End if
